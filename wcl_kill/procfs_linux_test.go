...
import (
	...
	"github.com/wsva/common_lib/wcl_kill"
)
...
func TestPidOf(t *testing.T) {
	...
	pids, err := wcl_kill.PidOf(filepath.Base(os.Args[0]))
	assert.Empty(t, err)
